...
with open('day10\\students.txt', 'r') as file:
    for line in file:
...
with open('day10\\top_students.txt','w') as file2:
    for name,score in scores:
        if average<score :
            file2.write(f"{name} : {score}\n")
    # print(file2.read)

with open('day10\\top_student.csv','a', newline='') as csvfile :
...
with open('day10\\top_student.csv', 'r') as file:
